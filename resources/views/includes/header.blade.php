 ...
 <link rel="stylesheet" href="{{ asset('frontend/css/font-awesome.min.css')}}css/font-awesome.min.css" type="text/css" />
       ...
       <div class="container">
         <div class="ht-left">
           <div class="mail-service">
             <i class=" fa fa-envelope"></i> misbach3103@gmail.com
           </div>
           <div class="phone-service">
             <i class=" fa fa-phone"></i> 0821-1221-2104
           </div>
         </div>
       </div>
     </div>
